{
    "title": "A Small Glossary on GDPR – Explaining Key Terms and Concepts",
    "heading": "Small Glossary on GDPR<br><span class='color-gray-800' style='font-size: 0.75em;'>Explaining Key Terms and Concepts.</span>",
    "type": "blog",
    "slug": "GDPR-Glossary",
    "date": "2019-02-16T16:44:39+02:00",
    "description": "Like many laws, GDPR may seem complicated at first glance so it is important that we keep most important ideas and concepts short so that you can keep track",
...
The GDPR, like any other law can seem confusing at first glance. It introduces many legal concepts that are very important for understanding the regulations. 

What is a "responsible person" and how do they differ from the processor? Who do I have to contact if I want to assert my rights against a company?

In order to understand and take advantage of your new rights and extra privacy, we will explain in this article the most important terms and concepts around GDPR. You'll notice that it's not that hard when you know slight bit on the subject.

## What is the GDPR?

The GDPR (short for General Data Protection Regulation) is a new EU Regulation that came into force on 25 May 2018 and regulates data protection in the European Union. It aims to give citizens better control over their data and to synchronize some of the law across the EU.

As an EU regulation, the GDPR does not have to be implemented by member states but is directly put into applicable law. In doing so, it largely relaces previous dara protection laws, such as the German BDSG (Federal Data Protection Act). However, dome indevidual aspects can be designed by memner states, which is why the (new) BDSG exists in Germany.

## Ideas and Concepts

### Supervisory Authority

The [Data Protection Supervisors]({{< ref "supervisory-authorities" >}}) are independant bodies in each EU country whose job it is to ensure complience with data protection regulation, in particular, the GDPR.

Because of this, they may be in contact [those responsible](#verantwortlicher), ask them to comply with data protection law and, if nescessary, impose fines on the offender. As a consumer, you stand by as help: If you believe a person is not processing your data correctly, you can turn to the data protection supervisory authorities for free at any time.

If you are not sure on which authority to contact, look at our [Privacy-Inspector-Finder]({{< ref "supervisory-authorities" >}}#finder).
...
<!-- TODO: Link more ressources here once we have written those posts.
